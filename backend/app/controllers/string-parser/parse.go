...
// NewParseHandler creates POST /api/parse handler with injected capitals config.
func ParseHandler(capitals map[string]string) fiber.Handler {
	return func(c *fiber.Ctx) error {
		...
		enrichedCity := parser.EnrichCity(rawCity, capitals)
